...
{l.artisan_statut==="arrive"&&<div style={{marginTop:12,padding:"12px 16px",background:"rgba(34,197,94,0.08)",border:"1px solid rgba(34,197,94,0.2)",borderRadius:12}}><div style={{fontSize:13,fontWeight:700,color:"#22c55e"}}>✅ Votre artisan est arrivé — intervention en cours</div></div>}
                  </div>
                )}
              </div>
            ))}
