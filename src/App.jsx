...
const SPECIALITES_CATEGORIES = [
  ...
  { cat: "Amenagement interieur", items: ["Peinture & Enduit","Carrelage & Faience","Parquet & Sol","Faux plafond","Cuisine equipee","Salle de bain","Dressing & Rangement"] },
...
const TRAVAUX_CATS=[{id:"plomberie",label:"Plomberie & Eau",img:"https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Fuite d eau","Robinet","WC bouche","Chauffe-eau","Salle de bain","Piscine"]},{id:"elec",label:"Electricite",img:"https://images.images.pexels.com/photos/5663011/pexels-photo-5663011.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Panne","Installation","Tableau","Borne recharge","Alarme","Domotique"]},{id:"renov",label:"Renovation",img:"https://images.images.pexels.com/photos/30482688/pexels-photo-30482688.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Peinture","Carrelage","Faux plafond","Cuisine","Dressing","Decoration"]},{id:"fen",label:"Fenetres & Portes",img:"https://images.images.pexels.com/photos/36406089/pexels-photo-36406089.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Fenetres","Porte entree","Porte garage","Volets","Veranda","Portail"]},{id:"chauf",label:"Chauffage",img:"https://images.images.pexels.com/photos/5663011/pexels-photo-5663011.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Chauffage panne","Chaudiere","Climatisation","Pompe chaleur","Isolation","Solaire"]},{id:"gros",label:"Gros Oeuvre",img:"https://images.images.pexels.com/photos/9712971/pexels-photo-9712971.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Fissures","Extension","Demolition","Terrassement","Construction","Ravalement"]},{id:"ext",label:"Exterieur",img:"https://images.images.pexels.com/photos/16239801/pexels-photo-16239801.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Jardin","Terrasse","Elagage","Paysagisme","Allee","Cloture"]},{id:"serr",label:"Serrurerie",img:"https://images.images.pexels.com/photos/30958693/pexels-photo-30958693.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Porte bloquee","Serrure","Blindage","Urgence","Alarme","Camera"]},{id:"toit",label:"Toiture",img:"https://images.images.pexels.com/photos/37704246/pexels-photo-37704246.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Fuite","Tuiles","Nettoyage","Charpente","Gouttieres","Velux"]},{id:"cuis",label:"Cuisine & SDB",img:"https://images.images.pexels.com/photos/19984614/pexels-photo-19984614.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Cuisine","Salle de bain","Douche","Faience","Robinetterie","Plan travail"]},{id:"energ",label:"Energie",img:"https://images.images.pexels.com/photos/6876537/pexels-photo-6876537.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Solaire","Pompe chaleur","Isolation combles","Isolation murs","VMC","Cheminee"]},{id:"div",label:"Divers",img:"https://images.images.pexels.com/photos/30958693/pexels-photo-30958693.jpeg?auto=compress&cs=tinysrgb&w=400",subs:["Debarras","Nettoyage","Desamiantage","Ramonage","PMR","Nuisibles"]}];
...
const STEPS=[{id:"type",title:"En quoi pouvons-nous vous aider ?",sub:"Selectionnez votre besoin",type:"categories"},{id:"precision",title:"Precisez votre besoin",sub:"Choisissez parmi les options",type:"subcategories"},{id:"surface",title:"Surface du chantier",sub:"Indiquez la superficie",type:"input",placeholder:"Ex: 45 m2"},{id:"budget",title:"Budget estime",sub:"Indiquez votre budget",type:"input",placeholder:"Ex: 8 000 EUR"},{id:"artisans",title:"Nombre d artisans",sub:"Combien souhaitez-vous rencontrer ?",type:"single",opts:[{icon:"3",label:"3 artisans"},{icon:"4",label:"4 artisans"},{icon:"5",label:"5 artisans"},{icon:"+",label:"+ de 5"}]},{id:"calendar",title:"Vos disponibilites",sub:"Min 3 creneaux",type:"calendar"},{id:"contact",title:"Vos coordonnees",sub:"Recevez vos devis gratuits sous 24h",type:"form"}];
