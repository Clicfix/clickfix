...
                      </div>
                    ))}
                    {l.paiement_statut==="en_attente_validation"&&<div style={{marginTop:12,background:"rgba(255,111,0,0.08)",padding:"12px",borderRadius:10}}><div style={{fontSize:11,fontWeight:700,color:"#FF6F00",marginBottom:8}}>ARTISAN A TERMINE</div><div style={{fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:12}}>{(l.artisan_nom||"L artisan")+" propose : "+l.prix_final+"EUR"}</div><div style={{display:"flex",gap:8}}><button onClick={e=>{e.stopPropagation();const AK="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJpcHF0cWV6bnR6Y214d2lhcWR6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDA3OTkxMCwiZXhwIjoyMDk1NjU1OTEwfQ.NJxvcp7MJEGbpNmvjkwDGc4CJCswcoLZdGUSw0EDisU";fetch("https://bipqtqezntzcmxwiaqdz.supabase.co/rest/v1/leads?id=eq."+l.id,{method:"PATCH",headers:{"Content-Type":"application/json","apikey":AK,"Authorization":"Bearer "+AK},body:JSON.stringify({paiement_statut:"paye"})});ctx.notify("Paiement valide");}} style={{flex:1,padding:"10px",background:"#22c55e",border:"none",borderRadius:10,color:"#fff",fontWeight:700,fontSize:13,cursor:"pointer"}}>Valider et payer</button><button onClick={e=>{e.stopPropagation();const AK="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJpcHF0cWV6bnR6Y214d2lhcWR6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDA3OTkxMCwiZXhwIjoyMDk1NjU1OTEwfQ.NJxvcp7MJEGbpNmvjkwDGc4CJCswcoLZdGUSw0EDisU";fetch("https://bipqtqezntzcmxwiaqdz.supabase.co/rest/v1/leads?id=eq."+l.id,{method:"PATCH",headers:{"Content-Type":"application/json","apikey":AK,"Authorization":"Bearer "+AK},body:JSON.stringify({paiement_statut:"pre_autorise"})});ctx.notify("Refuse");}} style={{flex:1,padding:"10px",background:"rgba(239,68,68,0.15)",border:"1px solid rgba(239,68,68,0.2)",borderRadius:10,color:"#ef4444",fontWeight:700,fontSize:13,cursor:"pointer"}}>Refuser</button></div></div>}
                  </div>
                )}
              </div>
            ))}
                    {l.paiement_statut==="en_attente_validation"&&<div style={{marginTop:14,paddingTop:14,borderTop:"0.5px solid rgba(255,255,255,0.06)",background:"rgba(255,111,0,0.08)",padding:"12px",borderRadius:10}}><div style={{fontSize:11,fontWeight:700,color:"#FF6F00",marginBottom:8}}>ARTISAN A TERMINE</div><div style={{fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:12}}>{l.artisan_nom||"L artisan"} propose : <span style={{fontWeight:700,color:"#FF6F00"}}>{l.prix_final}EUR</span></div><div style={{display:"flex",gap:8}}><button onClick={e=>{e.stopPropagation();const AK="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJpcHF0cWV6bnR6Y214d2lhcWR6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDA3OTkxMCwiZXhwIjoyMDk1NjU1OTEwfQ.NJxvcp7MJEGbpNmvjkwDGc4CJCswcoLZdGUSw0EDisU";fetch("https://bipqtqezntzcmxwiaqdz.supabase.co/rest/v1/leads?id=eq."+l.id,{method:"PATCH",headers:{"Content-Type":"application/json","apikey":AK,"Authorization":"Bearer "+AK},body:JSON.stringify({paiement_statut:"paye"})});ctx.notify("Paiement valide");}} style={{flex:1,padding:"10px",background:"#22c55e",border:"none",borderRadius:10,color:"#fff",fontWeight:700,fontSize:13,cursor:"pointer"}}>✓ Valider et payer</button><button onClick={e=>{e.stopPropagation();const AK="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJpcHF0cWV6bnR6Y214d2lhcWR6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDA3OTkxMCwiZXhwIjoyMDk1NjU1OTEwfQ.NJxvcp7MJEGbpNmvjkwDGc4CJCswcoLZdGUSw0EDisU";fetch("https://bipqtqezntzcmxwiaqdz.supabase.co/rest/v1/leads?id=eq."+l.id,{method:"PATCH",headers:{"Content-Type":"application/json","apikey":AK,"Authorization":"Bearer "+AK},body:JSON.stringify({paiement_statut:"pre_autorise"})});ctx.notify("Prix refuse");}} style={{flex:1,padding:"10px",background:"rgba(239,68,68,0.15)",border:"1px solid rgba(239,68,68,0.2)",borderRadius:10,color:"#ef4444",fontWeight:700,fontSize:13,cursor:"pointer"}}>✕ Refuser</button></div></div>}
          </div>
        )}
      </div>
    )}
