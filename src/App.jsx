      ...
      <div style={{ zIndex:2, width:"100%", maxWidth:isLogin?420:560, animation:"fadeUp .4s ease" }}>
        ...
        <div style={S.authCard}>
          ...
          <div style={{ display:isLogin||isAdmin?"block":"grid", gridTemplateColumns:"1fr 1fr", gap:12 }}>
            ...
            <div style={{ gridColumn:"1/-1" }}><div><Inp label="Email *" v={f.email} set={set("email")} type="email"/>{errors.email&&<div style={{fontSize:11,color:"#ef4444",marginTop:3}}>{errors.email}</div>}</div></div>
            {!isLogin&&!isAdmin&&<>
              <div><Inp label="Telephone *" v={f.tel} set={set("tel")} type="tel"/>{errors.tel&&<div style={{fontSize:11,color:"#ef4444",marginTop:3}}>{errors.tel}</div>}</div>
            ...
            <div style={{ gridColumn:"1/-1" }}><div><Inp label="Mot de passe *" v={f.pass} set={set("pass")} type="password"/>{errors.pass&&<div style={{fontSize:11,color:"#ef4444",marginTop:3}}>{errors.pass}</div>}</div></div>
          </div>
