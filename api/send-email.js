...
const row=(l,v)=>`<div style="display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid rgba(255,255,255,0.06)"><span style="color:rgba(255,255,255,0.45);font-size:13px">${l}</span><span style="color:#fff;font-size:13px;font-weight:700">${v}</span></div>`;
